...
const pgData = [
    {
        ...
        title: "mirage", //the title of the page (leaving this blank will default it to "Page X")
        date: writeDate(2025, 4, 6), //the date on which the page was posted (mainly for the archive). The date is written using a function called "writeDate", basically just put writeDate and then some parenthesis and, comma separated, the year followed by the month and the day. Don't forget another comma at the end outside the parenthesis!
        ...
        authorNotes: `
            <p>first page of a planned 82, divided into three chapters. this is an experiment, i have never written a comic of this length before, nor attempted to release pages on a serial basis. updates will release in 5 page batches every sunday. this amounts to 20 pages a month, so the comic will be concluded by late summer-- given stable life circumstance and ample time, of course..</p>
            <p>inspired by a dream that stuck with me long after having woken.</p>
            `,
    },  
    // {
    //     pgNum: 2,
